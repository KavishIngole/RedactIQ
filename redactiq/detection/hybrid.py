...
class HybridDetector:
    ...
    def _merge_llm_priority(
        ...
        for rule_ent in rule_entities:
            if not any(self._spans_overlap(rule_ent, llm_ent) for llm_ent in llm_entities):
    ...
    def _merge_rule_priority(
        ...
        for llm_ent in llm_entities:
            if not any(self._spans_overlap(llm_ent, rule_ent) for rule_ent in rule_entities):
